...
describe('<Header/>', () => {
    describe('Success', () => {
        ...
        it('renders the header component and activats dark mode using onClick ', () => {
        ...
        it('renders the header component and activats dark mode using onKeyDown ', () => {
            const darkMode = false;
            const setDarkMode = jest.fn(() => !darkMode)
            const { queryByTestId } = render(<Header darkMode={darkMode} setDarkMode={setDarkMode} />)
            expect(queryByTestId('header')).toBeTruthy()
        ...
        it('renders the header component and set quick task to true using onKeyDown ', () => {
            const darkMode = false;
            const { queryByTestId } = render(<Header darkMode={darkMode} />)
            expect(queryByTestId('header')).toBeTruthy()
